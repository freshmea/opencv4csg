...
void MatOp2()
{
	Mat img1 = imread("study2/matOp/dog.bmp");
	...
	img4.setTo(Scalar(0, 0, 255));	// yellow
...
void MatOp5()
{
	Mat img1 = imread("/study2/matOp/lenna.bmp");
...
void MatOp7()
{
	Mat img1 = imread("/study2/matOp/lenna.bmp", IMREAD_GRAYSCALE);
